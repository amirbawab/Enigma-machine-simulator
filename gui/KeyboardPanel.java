...
public class KeyboardPanel extends JPanel{
	...
	public KeyboardPanel() {
		...
		// Create buttons
		for(int i=0; i<26; i++){
			alphaButtons[i] = new JButton(""+(char)('A'+i), new ImageIcon(getClass().getResource("images/button.png")));
			...
			alphaButtons[i].setPressedIcon(new ImageIcon(getClass().getResource("images/button_clicked.png")));
